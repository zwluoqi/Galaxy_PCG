Shader "URP_CUSTOM/ShapeWithOceanPassShader"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #include "Lit/CustomLitInput.hlsl"
            #include "Lit/CustomLitForwardPass.hlsl"                       
        ...
        Pass
        {
            Name "Unlit"
            Tags{"LightMode" = "UniversalForward" }
            Tags {"RenderType" = "Transparent" "Queue" = "Transparent" "IgnoreProjector" = "True" "RenderPipeline" = "UniversalPipeline" "ShaderModel"="4.5"}
            ...
            #include "Unlit/CustomMultipleUnlitInput.hlsl"
            #include "Unlit/CustomMultipleUnlitPass.hlsl"
    ...
    SubShader
    {
        ...
        // this Subshader will fail. One can add a subshader below or fallback to Standard built-in to make this
        // material work with both Universal Render Pipeline and Builtin Unity Pipeline
        Tags{"RenderType" = "Transparent" "Queue" = "Transparent"  "RenderPipeline" = "UniversalPipeline" "UniversalMaterialType" = "Lit" "IgnoreProjector" = "True" "ShaderModel"="2.0"}
        LOD 300
