...
public class PlanetMesh : MonoBehaviour
{
    ...
    void UpdateMesh()
    {
        ...
        _terrainGenerate.UpdateMesh(resolution,_vertexGenerate,_gpuShapeGenerate,_colorGenerate);
    }
    
    void UpdateShape()
    {
        _vertexGenerate .UpdateConfig(ShapeSettting);
        _terrainGenerate.UpdateShape(_vertexGenerate,_gpuShapeGenerate);
    ...
    {
        _colorGenerate .UpdateConfig(ColorSettting);
        _terrainGenerate.UpdateColor(_colorGenerate);
    }
